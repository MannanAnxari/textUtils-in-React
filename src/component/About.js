        ...
        <div className='container' style={btnStyle}>
            ...
            <div className="accordion" id="accordionExample">
                <div className="accordion-item">
                    ...
                    <div id="collapseOne" style={btnTextStyle} className="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                ...
                <div className="accordion-item">
                    ...
                    <div id="collapseTwo" style={btnTextStyle} className="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                        <div className="accordion-body">
                ...
                <div className="accordion-item">
                    ...
                    <div id="collapseThree" style={btnTextStyle} className="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                        <div className="accordion-body">
